...
//     switch(t.name) {
//       case "Stealth":
//         data[0]['threshes'].push(t.stat, t.value, t.fill);
//         break;
//       case "Resistance":
//         data[1]['threshes'].push(t.stat, t.value, t.fill);
//         // data[1][`${i}symp`] = t.stat;
//         // data[1][`${i}value`] = t.value;
//         // data[1][`${i}colour`] = t.colour;
//         break;
//       case "Stage Speed":
//         data[2]['threshes'].push(t.stat, t.value, t.fill);
//         break;
//       case "Transmission":
//         data[3]['threshes'].push(t.stat, t.value, t.fill);
//         break;
//       default:
//         break;
//     }
...
//       {data.map((x) => {
//         return x.threshes.map((thresh, i) => {
//           return i % 3 === 0 ? 
//             <Scatter dataKey={thresh[i]} fill={thresh[i+1]} />
//             : null;
//         })
//       })}
